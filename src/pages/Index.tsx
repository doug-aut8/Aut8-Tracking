...
<div className="container mx-auto px-4 pt-8 pb-4">
  <div className="relative max-w-xl mx-auto group">
    ...
    <div className="relative flex items-center">
      ...
      <Input
        type="text"
        placeholder="Busque por nome ou ingredientes"
        value={searchTerm}
        onChange={(e) => setSearchTerm(e.target.value)}
        className="pl-12 pr-12 h-14 text-lg border-2 border-muted bg-card shadow-lg rounded-xl focus-visible:ring-primary focus-visible:border-primary transition-all"
      />
      {searchTerm && (
        <button
